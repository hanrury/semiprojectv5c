                    ...
                    while (params.hasNext()){
                        try{
                            ...
                            if(item.isFormField()){//텍스트 데이터라면
                                ...
                                // 첨부파일이 없는 경우 나머지 if 문 이후 코드 실행 안함
                                if (ufname.equals("")|| ufname == null) continue;
